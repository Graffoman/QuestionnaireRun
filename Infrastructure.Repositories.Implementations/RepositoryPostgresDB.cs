...
{
    public abstract class RepositoryPostgresDB<T, TPrimaryKey> : IRepositoryPostgresDB<T, TPrimaryKey> where T
        : class, IEntityPostgresDB<TPrimaryKey>
    {
        protected readonly DbContext Context;
        private readonly DbSet<T> _entitySet;

        protected RepositoryPostgresDB(DbContext context)
        {
            Context = context;
